...
<table>
	...
	<tr>
		<td>Responsable calidad:</td>
		<td class='dato'><?php echo $cliente['responsable_calidad']; ?></td>
	</tr>
	<tr>
		<td>Responsable administraci&oacute;n:</td>
		<td class='dato'><?php echo $cliente['responsable_administracion']; ?></td>
	</tr>
	<tr>
	...
	<tr>			
		<td>Email responsable calidad:</td>
		<td class='dato'><?php echo $cliente['email_resp_calidad']; ?></td>
	</tr>
	<tr>			
		<td>Web:</td>
	...
	<tr>			
		<td>Num. de cuenta:</td>
		<td class='dato'><?php echo $cliente['num_cuenta']; ?></td>
	</tr>
	<tr>			
		<td>Concepto de facturaci&oacute;n 1:</td>
		<td class='dato'><?php echo $cliente['concepto_facturacion_1']; ?></td>
	</tr>
	<tr>			
		<td>Concepto de facturaci&oacute;n 2:</td>
		<td class='dato'><?php echo $cliente['concepto_facturacion_1']; ?></td>
	</tr>
	<tr>			
		<td>Periodicidad de cobro:</td>
		<td class='dato'><?php echo $cliente['periodicidad_cobro']; ?></td>
	</tr>
	<tr>			
		<td>Facturado por:</td>
		<td class='dato'><?php echo $cliente['facturado_por']; ?></td>
	</tr>
</table>
<br>
