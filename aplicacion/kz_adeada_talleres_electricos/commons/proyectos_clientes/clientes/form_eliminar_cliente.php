...
///////////////////////////////////////////////////////////////////////////
?>
<br><h4>Eliminar cliente</h4><br>

<div class='mensaje_eliminar'><p>ATENCI&Oacute;N: Va a eliminar el siguiente cliente. &iquest;Continuar?</p></div>
<br />
<form action='index.php?menu=administracion_proyectos' method='POST'>	
	...
	<input class="bt-accion" type='submit' name='eliminar_cliente' value='ELIMINAR' />
