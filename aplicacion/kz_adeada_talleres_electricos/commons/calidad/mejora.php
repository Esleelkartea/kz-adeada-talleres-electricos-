...
<div id="menu_principal">
	<ul>
		...
		<li><a href="mejora.php" class="seleccionado">Mejora</a></li> 
		<li id="ir-ainicio"><a href="../../index/index.php">Volver</a></li>
	</ul>
</div>
	<div id="submenu">
		<ul>
			<li><a href="mej/ver_satisfaccion.php">Satisfacci&oacute;n clientes</a>|</li>
			<li><a href="mej/ver_noconformidades.php">No Conformidades</a>|</li>
			<li><a href="mej/ver_acpm.php">Acciones Correctivas/Mejora</a>|</li>
		    <li><a href="mej/informes.php">Informes</a></li>
	    </ul>
	</div>
