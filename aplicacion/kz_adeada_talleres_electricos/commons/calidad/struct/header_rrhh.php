...
<div id="general">
	<div id="cabecera">
	  ...
	  <div id="menu_principal">
	    ...
	    <div id="submenu">
			<ul>
				<li><a id='lnk_ver_personal' href="ver_personal.php">Personal</a>|</li>
				<li><a id='lnk_ver_perfiles' href="ver_perfiles.php">Perfiles</a>|</li>
				<li><a id='lnk_ver_cursos' href="ver_cursos.php">Cursos</a>|</li>
