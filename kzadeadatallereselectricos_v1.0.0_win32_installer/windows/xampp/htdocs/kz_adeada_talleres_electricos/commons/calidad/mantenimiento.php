...
<div id="menu_principal">
	<ul>
		...
		<li><a href="mantenimiento.php" class="seleccionado">Maquinaria</a></li>
	...
	<div id="submenu">
		<ul>
		    <li><a href="mant/ver_equipos.php">M&aacute;quinas</a>|</li>
		    <li><a href="mant/informes.php">Informes</a></li>
	    </ul>
	</div>
