...
function AddPage($orientation='', $format='',  $titulo = '')
{
	//Start a new page
	if($this->state==0)
	$this->Open();
...
function Header($titulo = 'Informe')
{
	if($this->PageNo()==1)
	 $this->Image(RAIZ."img/kz_instagi_e.jpg",10,10, 10,10);
	 $this->Cell(90);
	 $this->Cell(60,5,'Gistek',0,1,'L');
	 $this->Cell(90);
	 $this->Cell(60,5,$titulo,0,1,'L');
	 $this->Ln(6);
